...
type FlowRule struct {
	...
	Online       bool         `json:"onlineChargingChk,omitempty" yaml:"Online" bson:"Online" mapstructure:"Online"`
	Offline      bool         `json:"offlineChargingChk,omitempty" yaml:"Offline" bson:"Offline" mapstructure:"Offline"`
}
